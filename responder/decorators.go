...
func Header(name, value string) {
	router.DecorateHandler(http.HandlerFunc(func(w http.ResponseWriter, request *http.Request) {
		w.Header().Add(name, value)
	}), router.NoopHandler)
}

func HeaderRewrite(name, value string) {
	router.DecorateHandlerBefore(http.HandlerFunc(func(w http.ResponseWriter, request *http.Request) {
